...
/*个人信息*/
function myselfInfo(username,create_time){
	/*$.ajax({
            type:"POST",
            url:"/admin.php/home/user/userList",
	...
	layer.open({
		...
		shade:0.4,
		title: '查看信息',
		content: "<br>"+"<div align='center'>"+"用户名："+username+"</div>"+"" +
		"<div align='center'>"+"注册时间："+create_time+"</div>"
	});
}
$(function(){
