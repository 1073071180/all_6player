...
<article class="cl pd-20">
	<form action="/admin.php/home/user/add" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">备注(签名)：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="签名" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="textarealength(this,100)"></textarea>
