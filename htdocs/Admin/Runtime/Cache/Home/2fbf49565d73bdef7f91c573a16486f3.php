...
<div class="menu_dropdown bk_2">
    <dl id="menu-article">
        <dt class="selected"><i class="Hui-iconfont">&#xe616;</i> 资讯管理<?php echo (CONTROLLER_NAME); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
        <dd <?php if((CONTROLLER_NAME) == "Article"): ?>style="display:block"<?php endif; ?>>
            <ul>
                <li class="current">
                    <a href="/admin.php/home/Article/articleList" title="资讯管理">资讯管理</a>
                </li>
            </ul>
        </dd>
    </dl>
					...
					<table class="table table-border table-bordered table-bg table-hover table-sort">
						...
						<tbody>
							<tr class="text-c va-m">
								...
								<td>001</td>
								<td><a onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img width="60" class="product-thumb" src="/Public/style/pic/product/Thumb/6204.jpg"></a></td>
								<td class="text-l"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img title="国内品牌" src="/Public/style/static/h-ui/images/gq/cn.gif"> <b class="text-success">圣象</b> 哥本哈根橡木地板KS8373</a></td>
...
function product_shenhe(obj,id){
	...
	function(){
		...
		$(obj).remove();
    	layer.msg('未通过', 'icon:5,time:1000');//不能用花括号
	});
}
/*图片-下架*/
