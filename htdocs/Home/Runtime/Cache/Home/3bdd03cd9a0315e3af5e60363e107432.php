...
<head>
	...
	<script>
		...
		/*点击获取验证码*/
        $(document).on('click','#verifyCodeImg,#changeVerificationCode',function(e){
            var timenow = new Date().getTime();
            $('#verifyCodeImg').attr('src',"http://6player.cn/home.php/home/Common/verify/"+timenow);
        });
	</script>
...
<article class="cl pd-20">
	<form action="/home.php/home/user/add" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			&nbsp;&nbsp;&nbsp;<input name="code" id="code" type="text" style="width: 80px;height: 25px;">
			<img  id="verifyCodeImg" style="width: 180px;height: 40px" src="http://6player.cn/home.php/home/Common/verify" alt="验证码图片"/>
