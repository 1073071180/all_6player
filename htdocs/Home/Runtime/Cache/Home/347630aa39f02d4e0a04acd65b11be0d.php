...
<div class="am-g am-container">
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-8">
        <div class="newstitles">
            <h2><?php echo ($news["article_title"]); ?></h2>
            <img src="/Public/HomeStyle/Temp-images/face.jpg" class="face">
            <span>Rosis</span>
            发布时间：<?php echo ($news["create_time"]); ?>   阅读：<?php echo ($news["click_number"]); ?>
        </div>
        <a href="#"><img src="/<?php echo ($news["picture_url"]); ?>" class="am-img-responsive" width="100%"/></a>

        <div class="contents">

            <?php echo ($news["content"]); ?>

            <br><br><br>作者：<?php echo ($news["writer"]); ?></span></p>
            <p dir="ltr" style="text-align: justify; "><font color="#585858" face="arial, microsoft yahei, 宋体"><span style="line-height: 28px; background-color: rgb(255, 255, 255);">
                原文链接：<a href="$news.come_from" _src="$news.come_from"><?php echo ($news["come_from"]); ?></a> </span></font></p>
            <p dir="ltr" style="text-align: justify; "><font color="#585858" face="arial, microsoft yahei, 宋体"><br/></font></p>
        </div>
        <div class="shang">
            <img src="/Public/HomeStyle/images/shang.png" >
        </div>
